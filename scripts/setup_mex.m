...
% C library sources
cSources = { ...
    fullfile(csrcDir, 'pulseg_cache.c'), ...
    fullfile(csrcDir, 'pulseg_core.c'), ...
    fullfile(csrcDir, 'pulseg_dedup.c'), ...
    fullfile(csrcDir, 'pulseg_error.c'), ...
    fullfile(csrcDir, 'pulseg_freqmod.c'), ...
    fullfile(csrcDir, 'pulseg_getters.c'), ...
    fullfile(csrcDir, 'pulseg_math.c'), ...
    fullfile(csrcDir, 'pulseg_parse.c'), ...
    fullfile(csrcDir, 'pulseg_safety.c'), ...
    fullfile(csrcDir, 'pulseg_structure.c'), ...
    fullfile(csrcDir, 'pulseg_waveforms.c'), ...
