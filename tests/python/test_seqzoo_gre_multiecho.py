...
from pulserver.seqzoo import gre_multiecho_2d, gre_multiecho_3d
...
def design_2d(**kwargs):
    ...
    return gre_multiecho_2d.main(n_x=N_X, n_y=8, **kwargs)
...
def test_the_protocol_reports_the_echo_range():
    system = pp.Opts()
    for module in (gre_multiecho_2d, gre_multiecho_3d):
