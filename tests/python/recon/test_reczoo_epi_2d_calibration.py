...
:mod:`pulserver.seqzoo.epi_2d` for a plain (non-multiband) accelerated scan: a
...
from pulserver.reczoo import epi_2d
...
def test_the_calibration_maps_unalias_the_accelerated_slices(kspace, phantom, context):
    ...
    plugin = epi_2d.Epi2DRecon(iterations=60)
