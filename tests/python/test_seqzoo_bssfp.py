...
from pulserver.seqzoo import bssfp_2d, bssfp_3d
...
def design_2d(**kwargs):
    ...
    return bssfp_2d.main(n_x=N_X, n_y=8, **kwargs)
...
def design_3d(**kwargs):
    ...
    kwargs.setdefault("n_dummy", 2)
    kwargs.setdefault("readout_bandwidth_hz", BANDWIDTH)
    return bssfp_3d.main(n_x=N_X, n_y=8, n_z=4, slab_thickness=32e-3, **kwargs)
...
def test_the_default_protocol_is_feasible():
    system = pp.Opts()
    for module in (bssfp_2d, bssfp_3d):
