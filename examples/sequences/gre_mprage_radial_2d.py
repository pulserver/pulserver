...
counterpart this mirrors, and ``_gre_common.py`` / ``_prep_common.py`` /
``_t2prep_common.py`` / ``_mt_common.py`` for the shared building blocks):
...
def _build_cli_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate a 2D radial prepared GRE .seq offline.")
    parser.add_argument("-o", "--output", default="gre_mprage_radial_2d.seq", help="Output .seq file path")
