...
def Multiecho3DKernel(
    ...
    *,
    ...
    :func:`pulserver.seqzoo.gre_3d.GRE3DKernel` with the echo train of
    :func:`pulserver.seqzoo.gre_multiecho_2d.MultiechoKernel`: the readout
...
n_dummy, spoiling_cycles
    ...
    types.SimpleNamespace
        As :func:`pulserver.seqzoo.gre_3d.GRE3DKernel` returns, with
