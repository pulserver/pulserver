"""Image-space operations on the arrays a reconstruction produces.

Cropping an oversampled reconstruction back to its prescribed field of view,
combining the coil dimension away, and bringing a result off whichever device
it was computed on.
"""
    ...
    .. plot::
       ...
       images(
           [
               ("coil 0", coils[0]),
               ("coil 1", coils[1]),
               ("root sum of squares", mrd.coil_combine(coils, coil_axis=0)),
           ],
