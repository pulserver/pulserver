...
// event path needs; see pulseqpp_events.h.  Everything below is written
...
namespace
{
    ...
    py::array_t<double, py::array::c_style | py::array::forcecast> as_matrix(
    ...
    py::array_t<int32_t, py::array::c_style | py::array::forcecast> as_int_matrix(
        const py::object& source,
        int width,
        const char* what)
    {
...
void pulserver_bind_pulseqpp(py::module_& m)
{
    ...
    auto sequence_class =
        py::class_<Sequence>(m, "Sequence")
            ...
            .def(
                   ...
                   bool integers)
                {
                    self.set_definition(
                        key,
                        integers ? pulseq::Definition::integers(values)
            ...
            .def(
                "set_gradients",
                [](Sequence& self,
                   const py::object& traps,
                   const py::object& arbs,
            ...
            .def(
                ...
                [](Sequence& self, const py::array& events, const py::object& durations)
                {
                    ...
                    {
                        std::memcpy(
                            narrow.data() + static_cast<size_t>(row) * pulseq::BLOCK_WIDTH,
         ...
         */
            ...
            // call rather than one per event.  See pulseqpp_events.h.  It is
            ...
            // shape ids.  Backs Sequence.register_*_event -- see pulseqpp_events.h.
            .def(
                "warm_event",
            ...
            .def(
                "_bench_noop",
                [](Sequence&, const py::args& events) { return static_cast<int>(events.size()); })
            .def(
                "compress_shapes",
                &Sequence::compress_shapes,
            ...
            .def(
                ...
                {
                    const py::buffer_info info = samples.request();
                    return self.register_raw_shape(
                        static_cast<const double*>(info.ptr),
                        static_cast<int>(info.size));
                })
            ...
            .def(
                ...
                [](Sequence& self)
                {
                    ...
                    return py::array_t<int32_t>(
                        {self.num_blocks(), pulseq::BLOCK_WIDTH},
                        self.block_events(),
           ...
           so they get a scalar setter rather than a rebuild of the block. */
            ...
            .def(
                ...
                { return py::array_t<double>(pulseq::RF_WIDTH, s.rf_library().row(id)); })
            .def(
                "rf_use",
                [](const Sequence& s, int id)
            ...
            .def(
                ...
                [](const Sequence& s, int id) {
                    return py::array_t<double>(
                        pulseq::ROTATION_WIDTH,
                        s.rotation_library().row(id));
                })
            .def(
                "rf_shim_row",
                [](const Sequence& s, int id) {
                    return py::array_t<double>(
                        s.rf_shim_library().length(id),
            ...
            .def(
                 ...
                 * count. */
                    ...
                    for (int id : order)
                    {
                        ...
                        column.resize(static_cast<size_t>(steps), 0);
                        out[py::str(s.label_name(id))] = py::array_t<int>(steps, column.data());
                    }
                    return out;
                },
                py::arg("first"),
            ...
            .def(
                ...
                [](const Sequence& s, int id)
                {
                    const pulseq::SoftDelay& row =
                        s.soft_delay_library()[static_cast<size_t>(id) - 1];
            ...
            .def(
                ...
                [](const Sequence& s, int id)
                {
                    return py::make_tuple(
                        ...
                        py::array_t<double>(
                            s.shape_library().num_compressed(id),
            ...
            .def(
                ...
                [](Sequence& s)
                {
                    ...
                    for (size_t b = 0; b < origins.size(); ++b)
                        for (int a = 0; a < 3; ++a)
                            dst[b * 3 + static_cast<size_t>(a)] =
                                origins[b][static_cast<size_t>(a)];
                    return out;
                })
            ...
            .def(
                "calculate_kspace",
                [](Sequence& self,
                   std::array<double, 3> trajectory_delay,
                   std::array<double, 3> gradient_offset,
                   int first_block,
                   int last_block,
                   bool apply_rotation,
                   ...
                   bool dense)
                {
                    ...
                    out["k_adc"] = k_adc;
                    out["t_adc"] =
                        py::array_t<double>(static_cast<int>(ks.t_adc.size()), ks.t_adc.data());
                    out["k_traj"] = k_traj;
                    ...
                    out["t_slice_pos"] = py::array_t<double>(
                        static_cast<int>(ks.t_slice_pos.size()),
                        ks.t_slice_pos.data());
                    ...
                    out["k_center"] =
                        py::make_tuple(ks.k_center[0], ks.k_center[1], ks.k_center[2]);
            ...
            .def(
                   ...
                   int last_block)
                {
                    ...
                    out["table_index"] = py::array_t<int>(
                        static_cast<int>(m.table_index.size()),
                        m.table_index.data());
                    return out;
                })
            ...
            .def(
                   ...
                   const std::string& sort_slices)
                {
                    ...
                    out["adc_block"] = py::array_t<int>(
                        static_cast<int>(r.labels.adc_block.size()),
                        r.labels.adc_block.data());
            ...
            .def(
                "apply_labels",
                [](Sequence& self,
                   const std::vector<int>& adc_block,
