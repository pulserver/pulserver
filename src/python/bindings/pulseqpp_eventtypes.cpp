...
namespace pulseqpp_types
{
    ...
    {
        static const char* base_name = "pulserver._ext.pulseqpp.Event";
        ...
        ready<RfEvent>(
            m,
            RfType,
            "pulserver._ext.pulseqpp.RfEvent",
            rf_members,
            rf_getset,
            &rf_sequence);
        ready<TrapEvent>(
            m,
            TrapType,
            "pulserver._ext.pulseqpp.TrapEvent",
            trap_members,
            trap_getset);
        ready<GradEvent>(
            m,
            GradType,
            "pulserver._ext.pulseqpp.GradEvent",
            grad_members,
            grad_getset,
            &grad_sequence);
        ready<AdcEvent>(m, AdcType, "pulserver._ext.pulseqpp.AdcEvent", adc_members, adc_getset);
        ready<LabelEvent>(
            m,
            LabelType,
            "pulserver._ext.pulseqpp.LabelEvent",
            label_members,
            label_getset);
        ready<TriggerEvent>(
            m,
            TriggerType,
            "pulserver._ext.pulseqpp.TriggerEvent",
            trigger_members,
            trigger_getset);
        ready<RotationEvent>(
            m,
            RotationType,
            "pulserver._ext.pulseqpp.RotationEvent",
            rotation_members,
            rotation_getset);
        ready<SoftDelayEvent>(
            m,
            SoftDelayType,
            "pulserver._ext.pulseqpp.SoftDelayEvent",
            soft_delay_members,
            soft_delay_getset);
        ready<DelayEvent>(
            m,
            DelayType,
            "pulserver._ext.pulseqpp.DelayEvent",
            delay_members,
            delay_getset);
