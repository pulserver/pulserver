...
namespace NHLBI
{
    ...
    public:
        ...
        static CompressedFloatBuffer* createCompressedBuffer(
            InstructionSet instructionSet = InstructionSet::Native);
        ...
        static float getScaleForBits(size_t precision_bits, float max_val)
        {
            ...
            if (scale == 0)
            {
                throw std::runtime_error(
                    "Please choose a higher value as the 'precision_bits' argument.");
            }
