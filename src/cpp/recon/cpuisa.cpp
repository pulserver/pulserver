...
#define cpuidex(info, leaf, subleaf) \
...
namespace
{
    ...
    InstructionSet::InstructionSet()
        : isIntel_{false}, isAMD_{false}, f_1_ECX_{}, f_1_EDX_{}, f_7_EBX_{}, f_7_ECX_{},
          f_81_ECX_{}, f_81_EDX_{}
    {
        int cpui[4] = {-1};
...
{
    return reinterpret_cast<const char*>(CPU_Rep.vendor_);
}
const char* CPU_Brand()
{
    return reinterpret_cast<const char*>(CPU_Rep.brand_);
}
