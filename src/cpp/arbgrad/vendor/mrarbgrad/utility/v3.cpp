...
{
    return bool(this->x == rhs.x && this->y == rhs.y && this->z == rhs.z);
}
...
{
    return sqrt(v3In.x * v3In.x + v3In.y * v3In.y + v3In.z * v3In.z);
}
...
{
    return f64(v3In0.x * v3In1.x + v3In0.y * v3In1.y + v3In0.z * v3In1.z);
}

v3 v3::pow(const v3& v3In, f64 exp)
{
    return v3(std::pow(v3In.x, exp), std::pow(v3In.y, exp), std::pow(v3In.z, exp));
}
...
bool v3::rotate(v3* pv3Dst, int iAx, f64 ang, const v3& v3Src)
{
    if (!pv3Dst)
        return false;
    bool ret = true;
...
bool v3::rotate(vv3* pvv3Dst, int iAx, f64 ang, const vv3& vv3Src)
{
    if (!pvv3Dst)
        return false;
    std::array<v3, 3> av3RotMat;
    if (!genRotMat(&av3RotMat, iAx, ang))
        return false;
...
bool v3::rotate(lv3* plv3Dst, int iAx, f64 ang, const lv3& lv3Src)
{
    if (!plv3Dst)
        return false;
    bool ret = true;
    ...
    {
        _lv3Dst.push_back(
            v3(v3::inner(av3RotMat[0], *ilv3CoordSrc),
