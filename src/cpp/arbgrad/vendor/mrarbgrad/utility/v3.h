...
public:
    ...
    static bool rotate(v3* pv3Dst, int iAx, f64 ang, const v3& v3Src);
    static bool rotate(vv3* pvv3Dst, int iAx, f64 ang, const vv3& vv3Src);
    static bool rotate(lv3* plv3Dst, int iAx, f64 ang, const lv3& lv3Src);
