...
public:
    MrTraj_2D(
        ...
        const i64& m_nStack,
        const f64& m_rotang,
        const v3& m_v3BaseM0PE,
        const vv3& m_vv3BaseGRO)
        : MrTraj(m_objGeoPara, m_objGradPara, m_nAcq, m_nSampMax), m_nStack(m_nStack),
          m_rotang(m_rotang), m_v3BaseM0PE(m_v3BaseM0PE), m_vv3BaseGRO(m_vv3BaseGRO)
    {
    }
