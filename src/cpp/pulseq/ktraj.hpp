...
namespace pulseq
{
    namespace detail
    {
        ...
        public:
            ...
            const std::vector<KTrajReadout>& readouts() const
            {
                return readouts_;
            }
            const std::vector<KTrajRf>& excitations() const
            {
                return excitations_;
            }
            const std::vector<KTrajRf>& refocusings() const
            {
                return refocusings_;
            }
             ...
             * merely a slow run.
             */
            int key_groups() const
            {
                return key_groups_;
            }

            /** The scan's closest approach to k = 0, 1/m. */
            const std::array<double, 3>& k_center() const
            {
                return k_center_;
            }
             ...
             */
            int central_readout() const
            {
                return central_readout_;
            }
             ...
             */
            const std::vector<double>& block_origins() const
            {
                return origin_;
            }
             ...
             */
            const std::vector<int>& grad_canon() const
            {
                return grad_canon_;
            }
            const std::vector<int>& adc_canon() const
            {
                return adc_canon_;
            }
