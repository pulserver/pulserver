...
namespace pulseq
{
    ...
    namespace
    {
        ...
        size_t binary_row_stride(uint32_t code)
        {
            ...
            {
            case 2:
                return 32; /* BLOCKS: i64 duration + 6 x i32     */
            case 3:
                return 73; /* RF: id + f64 + 3 i32 + 2 i64 + 4 f64 + use */
            case 4:
                return 44; /* GRADIENTS: id + 3 f64 + 2 i32 + i64 */
            case 5:
                return 44; /* TRAP: id + f64 + 4 i64             */
            case 6:
                return 64; /* ADC: id + 3 i64 + 4 f64 + i32      */
            case 9:
                return 16; /* EXTENSIONS: 4 x i32                 */
            case 10:
                return 28; /* TRIGGERS: 3 i32 + 2 i64             */
            case 11:
                return 12; /* LABELSET: 3 i32                     */
            case 12:
                return 12; /* LABELINC: 3 i32                     */
            case 15:
                return 36; /* ROTATIONS: i32 + quaternion (4 f64) */
            default:
                return 0;
            }
        }
        ...
        bool binary_has_type_id(uint32_t code)
        {
    ...
    uint64_t SequenceFile::get_u64(size_t offset) const
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            value |= static_cast<uint64_t>(static_cast<unsigned char>(bytes_[offset + i])) << shift;
        }
        return value;
    }
    ...
    uint32_t SequenceFile::get_u32(size_t offset) const
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            ...
            value |= static_cast<uint32_t>(static_cast<unsigned char>(bytes_[offset + i])) << shift;
        }
        return value;
    }
