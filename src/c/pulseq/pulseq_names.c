...
static const pulseq_table_entry label_table[] = {
    {"SLC", PULSEQ_LABEL_SLC},     {"SEG", PULSEQ_LABEL_SEG},     {"REP", PULSEQ_LABEL_REP},
    {"AVG", PULSEQ_LABEL_AVG},     {"SET", PULSEQ_LABEL_SET},     {"ECO", PULSEQ_LABEL_ECO},
    {"PHS", PULSEQ_LABEL_PHS},     {"LIN", PULSEQ_LABEL_LIN},     {"PAR", PULSEQ_LABEL_PAR},
    {"ACQ", PULSEQ_LABEL_ACQ},     {"NAV", PULSEQ_LABEL_NAV},     {"REV", PULSEQ_LABEL_REV},
    {"SMS", PULSEQ_LABEL_SMS},     {"REF", PULSEQ_LABEL_REF},     {"IMA", PULSEQ_LABEL_IMA},
    {"NOISE", PULSEQ_LABEL_NOISE}, {"PMC", PULSEQ_LABEL_PMC},     {"NOROT", PULSEQ_LABEL_NOROT},
    {"NOPOS", PULSEQ_LABEL_NOPOS}, {"NOSCL", PULSEQ_LABEL_NOSCL}, {"ONCE", PULSEQ_LABEL_ONCE},
    {"TRID", PULSEQ_LABEL_TRID},   {"OFF", PULSEQ_LABEL_OFF},     {NULL, -1}};
