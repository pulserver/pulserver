...
static const pulseg_param_entry g_param_table[] = {
    ...
    /* Prescription rotation, logical to physical, row-major (see the header). */
    {"fov_rotation_11", PULSEG_PARAM_FOV_ROTATION_11, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_12", PULSEG_PARAM_FOV_ROTATION_12, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_13", PULSEG_PARAM_FOV_ROTATION_13, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_21", PULSEG_PARAM_FOV_ROTATION_21, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_22", PULSEG_PARAM_FOV_ROTATION_22, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_23", PULSEG_PARAM_FOV_ROTATION_23, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_31", PULSEG_PARAM_FOV_ROTATION_31, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_32", PULSEG_PARAM_FOV_ROTATION_32, PULSEG_PTYPE_FLOAT},
    {"fov_rotation_33", PULSEG_PARAM_FOV_ROTATION_33, PULSEG_PTYPE_FLOAT},
