...
def make_rf_spoiling_schedule(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from pulserver.design import make_rf_spoiling_schedule
...
def make_phase_cycling_schedule(
    ...
    --------
    >>> import numpy as np
    >>> from pulserver.design import make_phase_cycling_schedule
...
def make_traps_schedule(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from pulserver.design import make_traps_schedule
    ...
    Feed it to an FSE train as a per-echo envelope scale::
        ...
        readout = design.make_fse_readout(system, fov, matrix, etl, refocusing,
