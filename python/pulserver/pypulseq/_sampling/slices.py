...
class SliceGroup:
    ...
    Examples
    --------
    >>> from pulserver.pypulseq import slice_groups
    >>> group = slice_groups(6, 3e-3, sms_factor=2)[0]
    >>> group.slice_indices
    (0, 3)
    >>> group.positions_m
    array([-0.0075,  0.0015])
...
def slice_groups(num_slices, spacing_m, *, order="interleaved", sms_factor=1):
    ...
    outer_product : combine the slice loop with other outer dimensions.
    """
