...
from .._ext._pulseg_wrapper import (
    _check_consistency,
    _check_safety,
...
from ._opts import Opts as _AnalysisOpts
...
class SequenceCollection(pp.Sequence):
    ...
    system : pp.Opts or pulserver.analysis.Opts, optional
    ...
    def __init__(
        ...
        num_averages: int = 1,
        system: pp.Opts | _AnalysisOpts | None = None,
    ):
    ...
    def check(
        ...
        *,
        ...
        forbidden_bands : list of (freq_min, freq_max, max_amplitude), optional
            ...
            (e.g., :class:`pulserver.analysis.Opts`); otherwise no mechanical resonance checks are performed.
